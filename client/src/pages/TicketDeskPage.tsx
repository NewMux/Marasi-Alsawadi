...
export default function TicketDeskPage() {
  ...
  const { data: pricing } = trpc.platform.tickets.purchasePreview.useQuery({ lines: previewLines, partnerEntityId: partnerEntityId ? Number(partnerEntityId) : undefined }, { enabled: previewLines.length > 0 && previewLines.length <= maxTicketsPerPurchase });
