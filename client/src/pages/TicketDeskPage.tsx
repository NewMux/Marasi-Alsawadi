...
export default function TicketDeskPage() {
  ...
  const { data: pricing } = trpc.platform.tickets.purchasePreview.useQuery({ lines: previewLines }, { enabled: previewLines.length === expectedLineCount && expectedLineCount > 0 });
