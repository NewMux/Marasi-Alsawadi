...
export default function PublicTicketPage() {
  ...
  return <main className="min-h-screen bg-canvas px-4 py-8 text-ink sm:px-6 sm:py-12 print:bg-white print:p-0">
    <div className="mx-auto max-w-xl">
      <div className="mb-5 flex items-center justify-between print:hidden"><div><div className="text-xs font-semibold uppercase tracking-[.16em] text-accent">Marasi Alsawadi Resort</div><div className="mt-1 text-sm text-muted">Customer entry ticket</div></div><Button variant="outline" className="rounded-full" onClick={() => window.print()}>Print ticket</Button></div>
