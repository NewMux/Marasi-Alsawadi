...
function Router() { const Page = isPublicDemoMode() ? DemoOperationsPage : OperationsPage; return <Switch>{routes.map((path) => <Route key={path} path={path} component={Page}/>)}</Switch>; }
