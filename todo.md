...
- [x] Save and push the complete current product state to the authorized NewMux GitHub `main` branch without fabricating unresolved Oman rate values. (Checkpoint `fbdf8fcc` pushed and verified on GitHub `main` at `fbdf8fcc7a790cb5e120107ac264c47c498c06e0`.)
