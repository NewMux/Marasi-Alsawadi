...
- [ ] Save a new recoverable checkpoint after the focused `/tickets` and `/finance` routing and navigation changes, then update the handover evidence with its version.
